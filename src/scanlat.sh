...
if [[ $2 == "" ]]; then
    ...
    python2 parse.py <../input/$1 >../output/naturalized_$1 2>../output/log_$1

    echo 'Getting positional vowel quantities...'
    python2 positional.py <../output/naturalized_$1 >../output/scanned_$1 2>>../output/log_$1
...
Naturalized text:       ' ../output/naturalized_$1
    ...
    echo 'Getting positional vowel quantities...'
    python2 positional.py <../input/$1 >../output/scanned_$1 2>../output/log_$1
    echo '
Done scanning.
'
fi
